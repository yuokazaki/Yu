<template>
  <div id="skillSection">
    ...
    <div id="skillExplain">
      <p>
        まだまだ経験が浅いですが、スキルをまとめました。自分一人で制作した事があるのは、LP（HTML,CSS)です。HTML,CSSは問題なく使用できます。今回ポートフォリオの作成で、フロントエンドのスキルがかなり身につきました。また、git,gitHubの使い方も学ぶ事ができました。開発はMacOSで行いました。バックエンドでの開発経験はありません。現在は、データベースとオブジェクト指向の学習中です。
      </p>
    </div>
